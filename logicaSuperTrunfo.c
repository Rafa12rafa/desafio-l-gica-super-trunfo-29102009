...
int main() {
    ...
    char nome2[30] = "Estados Unidos";

    int populacao1 = 374000000, populacao2 = 331000000;
    float area1 = 9815767.0, area2 = 9833517.0;
    float pib1 = 3.1, pib2 = 25.4; // em trilhões de dólares
    int pontosTuristicos1 = 35, pontosTuristicos2 = 78;
